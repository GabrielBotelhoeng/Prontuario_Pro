      ...
      >
          ...
          {[
            ...
            return (
              ...
              >
                <div
                  className={`
                    w-9 h-9 rounded-lg flex items-center justify-center mb-2.5 transition-colors duration-300
                    ${
                      active
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <FormField
            ...
            icon={IdCard}
            placeholder={
              profile === "medico" ? "Digite seu CRM" : "000.000.000-00"
            }
          ...
          <label className="flex items-start gap-3 pt-1 cursor-pointer group select-none">
            <span
              className={`
                mt-0.5 flex h-[18px] w-[18px] flex-shrink-0 items-center justify-center rounded-[5px] border transition-all duration-300
                ${
                  accepted
            ...
            <span className="text-[13px] text-muted-foreground leading-relaxed">
              Aceito os{" "}
              <a className="text-primary font-medium hover:underline underline-offset-4 cursor-pointer">
                termos de uso
              </a>{" "}
              e{" "}
              <a className="text-primary font-medium hover:underline underline-offset-4 cursor-pointer">
