...
const stats = [
  { label: "Pacientes hoje", value: "12", icon: Users, trend: "+3" },
  { label: "Consultas realizadas", value: "8", icon: Clock, trend: "+2" },
  { label: "Pacientes aguardando", value: "3", icon: UserRound, trend: "agora" },
];
    ...
    <DashboardLayout navItems={navItems} userName="Dr. Carlos" userRole="Clínica Geral">
      <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="flex-1 p-8 lg:p-10 flex flex-col justify-center">
              ...
              <p className="text-muted-foreground text-[15px] leading-relaxed max-w-lg">
                O Consultório Nossa Senhora do Rosário, localizado em Pirenópolis-Goiás,
                é uma referência em cuidados médicos na cidade. Com cinco anos de atuação,
                oferece atendimento especializado nas áreas de Clínica Geral e Ginecologia.
              </p>
            </div>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, hsl(var(--primary) / 0.08) 0%, hsl(270 70% 96%) 50%, hsl(var(--primary) / 0.06) 100%)",
            boxShadow:
              "0 8px 32px -12px hsl(var(--primary) / 0.25), inset 0 1px 0 0 hsl(0 0% 100% / 0.6)",
          }}
        >
          {/* Subtle glow accent */}
          <div
            className="pointer-events-none absolute -top-20 -right-20 w-64 h-64 rounded-full opacity-40 blur-3xl"
          ...
          <div className="relative flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  Análise preditiva atualizada em tempo real
                </p>
              </div>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-foreground leading-relaxed">
                      A IA detectou que <strong className="font-semibold">30% dos seus pacientes de hoje</strong> apresentam sintomas de virose sazonal. Sugerimos conferir o estoque de medicamentos específicos.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card/70 backdrop-blur-sm border border-amber-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-foreground leading-relaxed">
                      A paciente <strong className="font-semibold">Maria Silva (14:30)</strong> possui histórico de alergia severa a penicilina. IA já sinalizou o prontuário.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Action button */}
            <button
              onClick={() => { /* TODO: Implementar lógica no Cursor - Ver análise completa da IA */ }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="bg-card border border-border/40 rounded-2xl p-5 flex items-center gap-4 transition-all duration-300 hover:shadow-md"
        ...
        <div className="bg-card border border-border/40 rounded-2xl p-6 flex items-center gap-5" style={{ boxShadow: "0 1px 12px -4px rgba(0,0,0,0.05)" }}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-foreground font-bold text-lg tracking-tight">Maria Silva — 14:30</p>
            <p className="text-muted-foreground text-sm">Retorno · Clínica Geral</p>
          </div>
          <button 
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {quickActions.map((action) => (
              <button
                key={action.title}
                onClick={() => { /* TODO: Implementar lógica no Cursor - Ação Rápida: {action.title} */ }}
